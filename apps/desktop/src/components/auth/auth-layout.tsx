...
import { Eye, EyeOff, Minus, Sparkles, X, type LucideIcon } from "lucide-react";
...
export function AuthLayout({
  ...
  return (
    <div className="relative flex h-full w-full overflow-hidden rounded-xl bg-background">
      <AuthTitleBar />
      <AuthBrandPanel />
  ...
  return (
    <aside className="relative hidden w-[42%] shrink-0 flex-col justify-between overflow-hidden bg-foreground p-10 text-background sm:flex">
      ...
      <div className="relative flex items-center gap-2.5">
        <span className="flex size-9 items-center justify-center rounded-lg bg-background/10 ring-1 ring-background/20">
      ...
      <div className="relative space-y-4">
        <h2 className="text-[1.7rem] font-semibold leading-tight tracking-tight">
